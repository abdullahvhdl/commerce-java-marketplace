...
public class TaskResponse {
	...
	protected List<FormPropertyResponse> formProperties = new ArrayList<FormPropertyResponse>();
	...
	public List<FormPropertyResponse> getFormProperties() {
		return formProperties;
	}

	public void setFormProperties(List<FormPropertyResponse> formProperties) {
