...
<div id="page_content" data-ng-controller="EditStoreController"
	data-ng-init="init(${storeId })">
	<div id="page_heading">
		<h1 id="product_edit_name">Edit Store</h1>
	</div>
			...
			<div class="uk-width-xLarge-2-10 uk-width-large-3-10">
				<div class="md-card">
					<div class="md-card-content">
						<h3 class="heading_a">Active Catalog</h3>
						<select class="md-input" data-ng-model="store.activeCatalogId"
							data-ng-options="catalog.id as catalog.name for catalog in catalogs">
						</select>
					</div>
				</div>
				<div class="md-card">
					...
					<div class="md-card-content">
						<div class="uk-grid" data-uk-grid-margin="">
							<div class="uk-width-medium-1-1">
								<form name="editForm" data-ng-submit="saveStore($event)"
									novalidate>
									<div class="uk-form-row">
										...
										<div class="parsley-errors-list filled"
											ng-messages="editForm.uniqueId.$error">
									...
									<div class="uk-form-row">
										...
										<div class="parsley-errors-list filled"
											ng-messages="editForm.name.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									...
									<div class="uk-form-row">
										<label for="address1">Address 1</label> <input id="address1"
											...
											class="md-input" /> <span class="md-input-bar"></span>
										<div class="parsley-errors-list filled"
											ng-messages="editForm.address1.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									...
									<div class="uk-form-row">
										<label for="city">City</label> <input id="city" name="city"
											...
											class="md-input" /> <span class="md-input-bar"></span>
										<div class="parsley-errors-list filled"
											ng-messages="editForm.city.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									<div class="uk-form-row">
										...
										<div class="parsley-errors-list filled"
											ng-messages="editForm.state.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									<div class="uk-form-row">
										<label for="zipcode">Zipcode</label> <input id="zipcode"
											name="zipcode" required data-ng-model="store.address.zipCode"
											type="text" class="md-input" /> <span class="md-input-bar"></span>
										<div class="parsley-errors-list filled"
											ng-messages="editForm.zipcode.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									<div class="uk-form-row">
										<label for="country">Country</label> <input id="country"
											name="country" required data-ng-model="store.address.country"
											type="text" class="md-input" /> <span class="md-input-bar"></span>
										<div class="parsley-errors-list filled"
											ng-messages="editForm.country.$error">
											<span class="parsley-required" ng-message="required">This
												value is required.</span>
										</div>
									</div>
									<div class="uk-form-row">
										<div class="uk-width-medium-1-1">
											<button class="md-btn md-btn-primary" type="submit"
												ng-class="{'disabled':editForm.$invalid}">Save</button>
										</div>
									</div>
